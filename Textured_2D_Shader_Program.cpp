...
Textured_2D_Shader_Program::Textured_2D_Shader_Program(const Shader* vertex_shader, const Shader* fragment_shader)
	: Shader_Program("Shader_Program.Textured.2D", vertex_shader, fragment_shader)
{
}
...
void Textured_2D_Shader_Program::render(const Mesh* mesh, const Texture* texture, const glm::mat4* transformation) const
{
	...
	if (texture_coordinate_location == -1)
		std::cout << "Failed to get texture_coordinate_location" << std::endl;
